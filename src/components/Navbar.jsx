    ...
    return (
        <Navigation>
            <div className="morphi">
                <svg width={"53.194vw"} viewBox="0 0 704 724" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.3069 222C-18.0931 153.2 5.4736 13.3333 22.3069 -48L701.807 -149L766.307 122.5L727.807 723.5C649.14 724.5 473.707 717 401.307 679C310.807 631.5 351.807 555 276.807 515C201.807 475 244.807 369.5 218.807 329.5C192.807 289.5 72.8069 308 22.3069 222Z" fill="#FFF1DA"/></svg>
            </div>
            <Logo>
                <svg height={'2.361vw'} viewBox="0 0 116 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <Wrapper>
                ...
                <Auth>
                    ...
                    <Language>
                        <h5>EN</h5>
                        <span>
                            <svg width={"0.9vw"} viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.5 0.5L5 5L9.5 0.5" stroke="#212832"/></svg>
                        </span>
                    </Language>
                </Auth>
            </Wrapper>
