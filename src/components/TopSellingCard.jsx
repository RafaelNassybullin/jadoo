            ...
            <Texts>
                ...
                <Days>
                    <span className={'navigator'}>
                        <svg width="1.250vw" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path
...
const CardWrap = styled.div`
  ...
  @media (max-width: 433px) {
    ...
    box-shadow: 1.250vw 1.250vw 2.500vw #d1d1d1,
      -1.250vw -1.250vw 2.500vw #ffffff;
  }
